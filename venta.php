...
function micro_sanear_string($string){
  ...
  try {
    ...
    $mail->AddReplyTo("dtc@fisae.com.py","Soporte Fisae");
    ...
    $mail->AddBCC("dtc@fisae.com.py", "Soporte Fisae"); // RECIPIENTE COPIA OCULTA
    $mail->AddBCC("fiorella@fisae.com.py", "Fiorella Di Pardo"); // RECIPIENTE COPIA OCULTA
    // $mail->AddBCC("carlos.sosa@porta.com.py","Fiorella Di Pardo");
