					...
					<div class="col-12 col-md-11">
						<div class="grid-form">
							<div class="item-grid-form">
								<form action="<?php echo $root; ?>index.php" method="post" class="form-section-contact" id="form-section-contact">
									...
									<div class="form-group">
										...
										<input type="email" id="email" name="email" class="form-control" placeholder="Escriba su email">
									</div>
									<div class="form-group">
										<label class="title-input" for="telefono">Teléfono</label>
										<input type="text" id="telefono" name="telefono" class="form-control" placeholder="Escriba su teléfono">
									</div>
									<div class="form-group">
										<label class="title-input" for="telefono">Asunto</label>
										<input type="text" id="asunto" name="asunto" class="form-control" placeholder="Escriba el asunto">
									</div>
									<div class="form-group">
									...
									<div class="form-group form-container-button">
										<input class="btn-principal btn-enviar" type="submit" value="Enviar" name="enviar_mail" class="wpcf7-form-control wpcf7-submit" />
									</div>
								</form>
							</div>
							<div class="item-grid-form">
