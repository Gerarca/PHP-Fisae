...
<body class="single-post right-sidebar">
  <div id="page" class="hfeed site">
    ...
    <div id="content" class="site-content" tabindex="-1">
      <div class="container">
        <nav class="woocommerce-breadcrumb"><a href="<?php echo $root;?>">Inicio</a><span class="delimiter"><i class="fa fa-angle-right"></i></span><a href="<?php echo $root;?>blogs-new.php">Blogs</a><span class="delimiter"><i class="fa fa-angle-right"></i></span><?php echo $titulo_main ?></nav>
